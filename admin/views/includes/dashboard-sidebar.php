...
<aside id="slideDiv" class="translate-x-0 fixed top-0 start-0 bottom-0 z-[9999] w-[5rem] bg-gradient-to-r from-neutral-100 to-neutral-400 text-neutral-800 text-[0.7rem] font-semibold shadow-md shadow-neutral-800 transition-all duration-900 ease-in-out">
  ...
  <nav class="mt-14 space-y-2">
    <a href="<?php echo ROOT_URL; ?>/dashboard" class="group flex items-center justify-center py-2.5 w-[7rem] text-neutral-200 bg-neutral-800 rounded-r-full shadow-neutral-800 hover:shadow-lg transition-all duration-500 ease-in-out">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20" fill="currentColor" class="group-hover:translate-x-9 transition-all duration-700 ease-in-out">
      ...
      <span class="ml-2 group-hover:-ml-14 transition-all duration-700 ease-in-out">Dashboard</span>
    </a>
    <a href="<?php echo ROOT_URL; ?>/dashboard/services" class="group overflow-hidden relative w-full hover:w-[7rem] flex items-center pl-[1.7rem] py-2.5 hover:bg-neutral-400 hover:rounded-r-full shadow-neutral-800 hover:shadow-lg transition-all duration-900 ease-in-out">
      ...
      <span class="absolute -right-[6rem] group-hover:right-[20%] top-1/2 transform translate-y-[-50%] transition-all duration-900 ease-in-out">Services</span>
    </a>
    ...
    <a href="<?php echo ROOT_URL; ?>/dashboard/gallery" class="group overflow-hidden relative w-full hover:w-[7rem] flex items-center pl-[1.7rem] py-2.5 hover:bg-neutral-400 hover:rounded-r-full shadow-neutral-800 hover:shadow-lg transition-all duration-900 ease-in-out">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="20" height="20" fill="currentColor" class="group-hover:-translate-x-[0.9rem] transition-all duration-900 ease-in-out">
      ...
      <span class="absolute -right-[6rem] group-hover:right-[23%] top-1/2 transform translate-y-[-50%] transition-all duration-900 ease-in-out">Gallery</span>
    </a>
