...
<aside id="slideDiv" class="translate-x-0 fixed top-0 start-0 bottom-0 z-[9999] w-[5rem] bg-gradient-to-r from-neutral-100 to-neutral-400 text-neutral-800 text-[0.7rem] font-semibold shadow-md shadow-neutral-800 transition-all duration-900 ease-in-out">
  ...
  <nav class="mt-14 space-y-2">
    ...
    <a href="<?php echo ROOT_URL; ?>/dashboard/abouts" class="group flex items-center justify-center py-2.5 w-[7rem] text-neutral-200 bg-neutral-800 rounded-r-full shadow-neutral-800 hover:shadow-lg transition-all duration-500 ease-in-out">
      ...
      <span class="ml-2 group-hover:-ml-12 transition-all duration-700 ease-in-out">Abouts</span>
    </a>
