<div id="portfolioModal" class="hidden fixed inset-0 z-[99999] bg-black/70 flex justify-center items-center text-sm">
  <div class="relative bg-[#F5F5F5] w-[96%] md:w-[90%] rounded-lg shadow-lg shadow-neutral-800 overflow-hidden">
    <div id="portfolioModalLoading" class="absolute inset-0 flex justify-center items-center bg-white/70 z-50 hidden">
    ...
    <div id="portfolioModalHero" class="w-full h-[25rem] bg-cover bg-center flex flex-col justify-center items-center relative mb-14">
      ...
      <div class="relative z-20 hero-color mx-4 lg:mx-0 px-6 py-8 lg:py-12 rounded-md flex flex-col items-center shadow-md shadow-[#493821]">
        <h2 id="portfolioModalTitle" class="text-[#333333] text-3xl md:text-4xl relative font-bold"></h2>
        <p id="portfolioModalDescription" class="text-[#333333] text-lg md:text-xl relative mt-4"></p>
      </div>
    </div>

    <div class="absolute top-3 right-3">
      <button onclick="closePortfolioModal()" class="cursor-pointer bg-[#333333]/60 text-white px-3 py-1 rounded-full text-xs hover:bg-[#333333] transition-all duration-500 ease-in-out">Close</button>
    </div>
  </div>
</div>