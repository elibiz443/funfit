  ...
  <div class="w-[94%] lg:w-[90%] mx-auto">
    <div id="wrapper" class="flex items-center justify-between h-16 transition-all duration-500 ease-in-out">
      ...
      <nav class="hidden lg:flex items-center gap-8 text-md text-white tracking-tight font-medium">
        ...
        <a href="<?php echo ROOT_URL; ?>/programs" class="group cursor-pointer">
          <span class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
      ...
      <div class="flex items-center gap-3">
        <button onclick="location.href='<?php echo ROOT_URL; ?>/contacts'" class="hidden cursor-pointer lg:inline-flex items-center gap-2 bg-white text-neutral-600 text-sm font-semibold px-4 py-2 rounded shadow-md shadow-neutral-700 hover:scale-110 hover:shadow-none transition-all duration-700 ease-in-out">
