<!-- PROGRAMS / OFFERINGS -->
<section id="programs" class="py-12 bg-gradient-to-br from-[#f3d477]/50 via-[#daaa4a]/60 to-[#daaa4a]">
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-10">
      <h2 class="text-3xl font-bold text-[#1c1c1c]">Programs Designed for Every Body</h2>
      <p class="text-[#1c1c1c]/80 mt-2 max-w-2xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <article class="p-6 bg-stone-800 rounded-2xl border-2 border-[#f3d477] hover:border-[#daaa4a] shadow-lg shadow-stone-800 transition-all duration-500 ease-in-out">
