...
<section id="trainers" class="py-16 bg-gradient-to-bl from-neutral-400/90 via-[#f3d477]/40 to-[#daaa4a]/70">
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
      ...
      <div class="relative rounded-2xl overflow-hidden shadow-lg shadow-neutral-800">
        ...
        <div class="absolute inset-0 bg-gradient-to-b from-black/40 to-black/60 flex flex-col justify-center text-center text-white p-8">
