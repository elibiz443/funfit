<section class="relative w-full py-16 bg-gradient-to-br from-[#f3d477]/20 via-[#daaa4a]/50 to-[#1c1c1c]">
  ...
  <div class="relative z-10 max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    <div class="bg-stone-800 p-8 rounded-2xl backdrop-blur-sm border border-stone-700 shadow-2xl">
      <h4 class="text-2xl font-bold text-[#daaa4a] uppercase tracking-wide text-center">Get In Touch</h4>

      <form id="contactForm" class="space-y-5 mt-12">
