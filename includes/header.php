<header class="absolute top-0 left-0 z-[999] w-full bg-gradient-to-r from-[#1c1c1c] via-[#1c1c1c]/70 to-[#1c1c1c]/50 border-b border-neutral-200 transition-all duration-500 ease-in-out">
  <div class="w-[94%] lg:w-[90%] mx-auto">
    <div id="wrapper" class="flex items-center justify-between h-16 transition-all duration-500 ease-in-out">
      <a id="logo" href="<?php echo ROOT_URL; ?>" class="bg-[#201e1f] p-2 mt-11 rounded-md border border-white/20 hover:scale-105 transition-all duration-700 ease-in-out">
        <img src="<?php echo ROOT_URL; ?>/assets/images/logo/logo2.webp" class="h-12 md:h-16 lg:h-18 w-auto">
      </a>
      ...
      <nav class="hidden lg:flex items-center gap-8 text-md text-white tracking-tight font-medium">
        <a href="<?php echo ROOT_URL; ?>" class="group">
          ...
          <div class="h-0.5 w-0 mx-auto bg-white group-hover:w-full transition-all duration-500 ease-in-out"></div>
        </a>
        <a href="<?php echo ROOT_URL; ?>/abouts" class="group">
          <span class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
              <path d="M439.4 96L448 96C483.3 96 512 124.7 512 160L512 512C512 547.3 483.3 576 448 576L192 576C156.7 576 128 547.3 128 512L128 160C128 124.7 156.7 96 192 96L200.6 96C211.6 76.9 232.3 64 256 64L384 64C407.7 64 428.4 76.9 439.4 96zM376 176C389.3 176 400 165.3 400 152C400 138.7 389.3 128 376 128L264 128C250.7 128 240 138.7 240 152C240 165.3 250.7 176 264 176L376 176zM320 312C336.1 312 349.2 325.1 349.2 341.2C349.2 349.9 346.1 355.1 342.3 358.9C337.8 363.3 331.6 366.4 325.5 368.4C310.6 373.4 296 387.7 296 407.9C296 421.2 306.7 431.9 320 431.9C331.5 431.9 341.2 423.8 343.5 412.9C362.7 405.8 397.2 386.6 397.2 341.1C397.2 298.5 362.6 263.9 320 263.9C277.4 263.9 242.8 298.5 242.8 341.1C242.8 354.4 253.5 365.1 266.8 365.1C280.1 365.1 290.8 354.4 290.8 341.1C290.8 325 303.9 311.9 320 311.9zM348 480C348 464.5 335.5 452 320 452C304.5 452 292 464.5 292 480C292 495.5 304.5 508 320 508C335.5 508 348 495.5 348 480z"/>
            </svg>
            About Us
          </span>
          <div class="h-0.5 w-0 mx-auto bg-white group-hover:w-full transition-all duration-500 ease-in-out"></div>
        </a>
        <a id="programsButton" class="group cursor-pointer">
          <span class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
        ...
        <a href="<?php echo ROOT_URL; ?>/gallery" class="group">
          <span class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
        ...
        <a id="openBooking" class="group cursor-pointer">
          <span class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
      ...
      <div class="flex items-center gap-3">
        <button id="contactsButton" class="hidden cursor-pointer lg:inline-flex items-center gap-2 bg-white text-neutral-600 text-sm font-semibold px-4 py-2 rounded shadow-md shadow-neutral-700 hover:scale-110 hover:shadow-none transition-all duration-700 ease-in-out">
  ...
  <div id="socialMedia" class="border-t border-white/20 mt-2 transition-all duration-700 ease-in-out">
    <div class="flex items-center justify-end gap-4 md:gap-8 py-2 text-white mr-[2%] md:mr-[5%]">
      <a href="https://facebook.com/functionalfitness" target="_blank" class="hover:scale-110 transition-all duration-500 ease-in-out">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="h-3.5 w-3.5 md:h-5 md:w-5">
          <path d="M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256C0 376 82.7 476.8 194.2 504.5V334.2H141.4V256h52.8V222.3c0-87.1 39.4-127.5 125-127.5c16.2 0 44.2 3.2 55.7 6.4V172c-6-.6-16.5-1-29.6-1c-42 0-58.2 15.9-58.2 57.2V256h83.6l-14.4 78.2H287V510.1C413.8 494.8 512 386.9 512 256h0z"/>
        </svg>
      </a>
      <a href="https://wa.me/254706396189" target="_blank" class="hover:scale-110 transition-all duration-500 ease-in-out">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" class="h-3.5 w-3.5 md:h-5 md:w-5">
      ...
      <a href="https://instagram.com/functionalfitness" target="_blank" class="flex items-center hover:scale-110 transition-all duration-500 ease-in-out">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" class="h-3.5 w-3.5 md:h-5 md:w-5">
      ...
      <a href="https://x.com/functionalfitness" target="_blank" class="flex items-center hover:scale-110 transition-all duration-500 ease-in-out">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="h-3.5 w-3.5 md:h-5 md:w-5">
          <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/>
        </svg>
      </a>
      <a href="https://linkedin.com/search/results/all/?keywords=functional%20fitness" target="_blank" class="flex items-center hover:scale-110 transition-all duration-500 ease-in-out">
        <svg xmlns="http://www.w3.0000/svg" viewBox="0 0 448 512" fill="currentColor" class="h-3.5 w-3.5 md:h-5 md:w-5">
  ...
  <div id="mobileMenu" class="fixed z-[9999] top-0 right-0 h-screen w-64 glass-bg-color2 border-l border-white/20 transform translate-x-full transition-all duration-500 ease-in-out lg:hidden">
    ...
    <ul class="mt-20 space-y-6 text-center text-lg text-white font-medium">
      ...
      <li><a id="programsButton2" class="cursor-pointer block hover:text-yellow-400">Our Programs</a></li>
      ...
      <li><button id="contactsButton2" class="cursor-pointer bg-white text-neutral-600 text-sm px-3 py-2 rounded mt-4 hover:scale-110 transition-all duration-500 ease-in-out">Contact For More</button></li>
    </ul> 
  </div>
</header>
