  ...
  <div id="socialMedia" class="border-t border-white/20 mt-2 transition-all duration-700 ease-in-out">
    <div class="flex items-center justify-end gap-4 md:gap-8 py-2 text-white mr-[2%] md:mr-[5%]">
      <a href="#" class="hover:scale-110 transition-all duration-500 ease-in-out">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="h-3.5 h-3.5 md:h-5 md:w-5">
          <path d="M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256C0 376 82.7 476.8 194.2 504.5V334.2H141.4V256h52.8V222.3c0-87.1 39.4-127.5 125-127.5c16.2 0 44.2 3.2 55.7 6.4V172c-6-.6-16.5-1-29.6-1c-42 0-58.2 15.9-58.2 57.2V256h83.6l-14.4 78.2H287V510.1C413.8 494.8 512 386.9 512 256h0z"/>
        </svg>
      </a>
      <a href="#" class="hover:scale-110 transition-all duration-500 ease-in-out">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" class="h-3.5 h-3.5 md:h-5 md:w-5">
      ...
      <a href="#" class="flex items-center hover:scale-110 transition-all duration-500 ease-in-out">
        <svg xmlns="http://www.w3.0000/svg" viewBox="0 0 448 512" fill="currentColor" class="h-3.5 h-3.5 md:h-5 md:w-5">
